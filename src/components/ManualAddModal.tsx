    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" onClick={onClose}>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-5">
          ...
          <div className="flex gap-4 items-start">
            ...
            <div className="flex-1 space-y-2">
              ...
              {coverPreviewError && coverUrl && (
                <p className="text-xs" style={{ color: 'var(--color-error)' }}>Could not load image from this URL</p>
              )}
            </div>
          </div>
          ...
          {/* Title (required) */}
          <div>
            <label className="block text-xs font-medium uppercase tracking-wider mb-1.5" style={{ color: 'var(--color-on-surface-variant)' }}>
          ...
          <div>
            <label className="block text-xs font-medium uppercase tracking-wider mb-1.5" style={{ color: 'var(--color-on-surface-variant)' }}>
              ISBN <span className="normal-case" style={{ color: 'var(--color-outline)' }}>(optional)</span>
            </label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-xs font-medium uppercase tracking-wider mb-1.5" style={{ color: 'var(--color-on-surface-variant)' }}>
              Genre <span className="normal-case" style={{ color: 'var(--color-outline)' }}>(optional)</span>
            </label>
            <input
              type="text"
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              placeholder="Write a book description or summary..."
        ...
        <div className="p-6 pt-4 border-t" style={{ borderColor: 'var(--color-surface-dim)' }}>
          ...
          {!isValid && (
            <p className="text-center text-xs mt-2" style={{ color: 'var(--color-outline)' }}>Title is required to save</p>
          )}
        </div>
      </div>
    </div>
